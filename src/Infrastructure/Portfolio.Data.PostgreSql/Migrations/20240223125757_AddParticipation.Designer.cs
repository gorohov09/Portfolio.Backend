...
namespace Portfolio.Data.PostgreSql.Migrations
{
    ...
    [Migration("20240223125757_AddParticipation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Portfolio.Domain.Entities.ParticipationActivityDocument", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_participation_activity_document");

                    b.HasIndex("FileId")
                        .HasDatabaseName("ix_participation_activity_document_file_id");
            ...
            modelBuilder.Entity("Portfolio.Domain.Entities.ParticipationActivityDocument", b =>
                {
                    b.HasOne("Portfolio.Domain.Entities.File", "File")
                        .WithMany("ParticipationActivityDocuments")
                        .HasForeignKey("FileId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired()
                        .HasConstraintName("fk_participation_activity_document_files_file_id");

                    b.HasOne("Portfolio.Domain.Entities.ParticipationActivity", "Participation")
                        .WithOne("ParticipationActivityDocument")
                        .HasForeignKey("Portfolio.Domain.Entities.ParticipationActivityDocument", "ParticipationId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired()
                        .HasConstraintName("fk_participation_activity_document_participation_activity_part");
            ...
            modelBuilder.Entity("Portfolio.Domain.Entities.File", b =>
                {
                    b.Navigation("ParticipationActivityDocuments");
